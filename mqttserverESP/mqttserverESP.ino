...
dtostrf(event.acceleration.x, 4, 3, tempData);
strcat(data, tempData);
strcat(data, ",");
dtostrf(event.acceleration.y, 4, 3, tempData);
strcat(data, tempData);
strcat(data, ",");
dtostrf(event.acceleration.z, 4, 3, tempData);
strcat(data, tempData);

    client.publish("accel", data);

    memset(data, 0, sizeof(data));
//    client.publish("accelx", dtostrf(event.acceleration.x, 6, 2, data));
